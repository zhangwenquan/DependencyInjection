...
using Xunit;
using DependencyInjectionSpecificationTests = Microsoft.Extensions.DependencyInjection.Specification.Tests.V2.DependencyInjectionSpecificationTests;
...
namespace Microsoft.Extensions.DependencyInjection.Tests.V2
{
    ...
    {
        protected override IServiceProvider CreateServiceProvider(IServiceCollection2 collection) =>
