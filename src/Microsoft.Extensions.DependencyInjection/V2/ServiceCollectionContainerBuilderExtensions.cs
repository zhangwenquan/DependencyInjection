...
namespace Microsoft.Extensions.DependencyInjection.V2
{
    public static class ServiceCollectionContainerBuilderExtensions
    {
        ...
        /// </summary>
        /// <param name="services">The <see cref="IServiceCollection2"/> containing service descriptors.</param>
        /// <returns>The<see cref="IServiceProvider"/>.</returns>

        public static IServiceProvider BuildServiceProvider(this IServiceCollection2 services)
        {
