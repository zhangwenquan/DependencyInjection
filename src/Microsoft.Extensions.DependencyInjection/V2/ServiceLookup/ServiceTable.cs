...
namespace Microsoft.Extensions.DependencyInjection.V2.ServiceLookup
{
    internal class ServiceTable
    {
        ...
        private static GenericService CreateGenericService(ServiceDescriptor2 descriptor)
        {
        ...
        private bool TryCreateService(ServiceDescriptor2 descriptor, out IService service)
        {
            service = null;
