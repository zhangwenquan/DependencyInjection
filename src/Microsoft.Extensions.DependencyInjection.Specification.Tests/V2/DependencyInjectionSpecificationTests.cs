...
namespace Microsoft.Extensions.DependencyInjection.Specification.Tests.V2
{
    ...
    {
        protected abstract IServiceProvider CreateServiceProvider(IServiceCollection2 serviceCollection);
        ...
        public static TheoryData ServiceContainerPicksConstructorWithLongestMatchesData
        {
            get
            {
                ...
                return new TheoryData<IServiceCollection2, TypeWithSupersetConstructors>
                {
                    {
        ...
        public void ServiceContainerPicksConstructorWithLongestMatches(
            IServiceCollection2 serviceCollection,
